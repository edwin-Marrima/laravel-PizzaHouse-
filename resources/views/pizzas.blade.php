...
<div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center sm:pt-0">
    ...
    <div class="max-w-6xl mx-auto sm:px-6 lg:px-8" style="color: #f7fafc">
        ...
        <p>
            {{$type}}-{{$preco}}-{{$tamanho}}
            @if ($preco>15)
                <p>Esta pizza custa muito dinheiro</p>
            @elseif($preco<0)
                <p>Preco inaceitavel<p>
            @endif


            @unless($type=='hawaiian') <!--contrario de if-->
                <p>Sinto muito magrinho</p>
            @endunless
